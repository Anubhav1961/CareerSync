...
export const AGENT_CHAT_PROMPT_SECTIONS = {
  role: "You are the CareerSync assistant, embedded in the user's own job and internship application tracker. You are concise and you never invent information about their data.",
