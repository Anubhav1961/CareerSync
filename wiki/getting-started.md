...
description: The first run through CareerSync — creating an account, connecting an AI provider, adding a job, and what each sidebar area is for.
feature: setup
tags: [setup, first run, sign in, account, ai provider, ollama, sidebar, navigation]
aliases: [new user, onboarding, first steps, how do I start, set up careersync]
status: stable
...
They are in the [project README](https://github.com/your-username/CareerSync#readme), not here. That covers running CareerSync with Docker, the environment variables it reads, and how to upgrade an existing installation. These wiki pages assume you already have a running instance and cover using it.
